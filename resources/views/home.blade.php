...
<style>
        ...
        <div class="container text-white p-5">
            <div class="row gap-5">
                <div class="col d-flex flex-column justify-content-center">
                    ...
                    <p class="mb-4">
                        SMA Negri 2 Singaparna hadir sebagai tempat tumbuhnya generasi berprestasi. 
                ...
                <div class="col d-flex justify-content-center align-items-center gap-3">
                    <img src="{{asset('asset/image/team-presentation-7-74.svg')}}" width="450" height="450" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col mb-3">
                <div class="card p-3 shadow" style="width: 415px; height: 500px; border: none;">
                    ...
                    <p class="card-text" style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
    ...
    <img src="{{asset('asset/image/wave-haikei (2).svg')}}" alt="" style="width: 100%;">
    <div class="p-5" style="background-color: #003F91;">
        <div class="container">
            ...
            <div class="row d-flex justify-content-center align-items-center m-5 gap-5">
                <div class="col-4 d-flex justify-content-center align-items-center flex-column shadow" style="width: 300px; height: 180px; border-radius: 20px; background-color: #5DA9E9; color: white;">
                    <h3>Jumlah Guru</h3>
    ...
    <img src="{{asset('asset/image/wave-haikei (3).svg')}}" alt="" style="width: 100%;">
    <div class="container">
        <div class="d-flex justify-content-center align-items-center m-5 flex-column">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col d-flex flex-column justify-content-center">
                ...
                <p>
                    SMA Negri 2 Singaparna adalah institusi pendidikan menengah atas yang berkomitmen untuk memberikan pendidikan berkualitas tinggi kepada siswa-siswinya. 
                ...
                <p>
                    Terletak di jantung kota Jakarta, SMA Negri 2 Singaparna menawarkan berbagai program akademik dan ekstrakurikuler yang dirancang untuk mengembangkan potensi siswa secara menyeluruh. 
                ...
                <p>
                <p>
                    Bergabunglah dengan kami di SMA Negri 2 Singaparna, di mana masa depan gemilang dimulai dari sini.
                </p>
