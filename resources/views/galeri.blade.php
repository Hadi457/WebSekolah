    ...
    <div class="container mt-4 mt-md-5">
        <div class="text-center mb-4 mb-md-5">
            ...
            <p class="text-muted mx-auto" style="max-width: 600px;">
                Kumpulan dokumentasi kegiatan, prestasi, dan momen berharga di lingkungan {{ $profile->nama_sekolah }}.
                ...
                <div class="col-12 col-sm-6 col-lg-3 mb-3 mb-md-4" data-category="{{ $item->kategori }}">
                    <div class="h-100">
                        ...
                        <div class="mt-3 px-2">
                            ...
                            @if($item->keterangan)
                                <p class="text-muted small mb-2" style="line-height: 1.4;  display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden;">
                                    {{ $item->keterangan }}
                                </p>
                            @endif
                            <!-- Tanggal upload -->
